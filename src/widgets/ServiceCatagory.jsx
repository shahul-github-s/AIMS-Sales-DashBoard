    ...
    const fetchData = async () => {
      try {
        const response = await axios.get(
          "https://script.google.com/macros/s/AKfycbxTl2PiERe4xQSSFau4lNszUQSpz7C8_90W7QRwBj9DfwKooElA7BnhXLAsCCJifgbO/exec"
        );
        ...
        setError();
        // "Failed to fetch data. Please check your network connection or try again later." // Set error message
      }
    };
