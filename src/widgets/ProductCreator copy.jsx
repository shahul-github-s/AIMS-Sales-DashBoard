...
const ProductCreator = () => {
  ...
  const { containerRef: galleryContainerRef, isDragging: galleryIsDragging } =
    useDraggableScrollContainer();
  const { containerRef: tagsContainerRef, isDragging: tagsIsDragging } =
    useDraggableScrollContainer();
  ...
  return (
    <Spring className="layout-wrapper h-full">
      <form
        className="h-full grid grid-cols-1 gap-6 md:gap-8 lg:grid-cols-2"
          ...
          <div className="flex flex-col gap-3 md:gap-4">
            ...
            <div className="card-container card-container--light p-4 rounded-2xl flex flex-col gap-3 md:gap-5">
              ...
              <div className="field-wrapper">
                ...
                <textarea
                  className="field-input !h-[78px] !py-4"
                  id="description"
          ...
          <div className="flex flex-col gap-3 md:gap-4">
            ...
            <div className="card-container card-container--light p-4 rounded-2xl flex flex-col gap-3 md:gap-5">
              <div className="field-wrapper">
                ...
                <Controller
                  ...
                  render={({ field }) => (
                    <Select
                      className={classNames("field-input", {
                        "field-input--error": errors.category,
                      })}
                      id="category"
              ...
              <div className="field-wrapper">
                ...
                >
                  {tags &&
                    tags.map((tag, index) => (
                      <Tag
                        className="dark:!border-[var(--border)] dark:hover:!border-turquoise"
                        key={index}
                        value={tag}
                  ...
                  <input
                    className="flex-1 bg-transparent min-w-[300px]"
                    id="tags"
              ...
              <div className="field-wrapper">
                ...
                <textarea
                  className="field-input !h-[88px] !py-4"
                  id="shortDescription"
          ...
          <div className="flex flex-col gap-3 md:gap-4">
            ...
            <div className="card-container card-container--light p-4 rounded-2xl flex flex-col gap-3 md:gap-5">
                ...
                <div className="field-wrapper">
                  ...
                  <Controller
                    ...
                    render={({ field }) => (
                      <Select
                        className={classNames("field-input", {
                          "field-input--error": errors.publishStatus,
                        })}
                        id="publishStatus"
                ...
                <div className="field-wrapper">
                  ...
                  <Controller
                    ...
                    render={({ field }) => (
                      <Select
                        className={classNames("field-input", {
                          "field-input--error": errors.visibilityStatus,
                        })}
                        id="visibilityStatus"
              ...
              <div className="field-wrapper">
                ...
                {/*                />*/}
                {/*            )}/>*/}
                <DatePicker value={time} onChange={setTime} id="schedule" />
              </div>
            </div>
          </div>
        </div>
        <div className="card p-5 flex flex-col gap-4 xs:p-6 md:gap-6">
          <div className="flex flex-col gap-3 md:gap-4">
            ...
            <div className="card-container card-container--light p-4 rounded-2xl flex flex-col gap-3 md:gap-5">
              <div className="field-wrapper">
                ...
                <input
                  className={classNames("field-input", {
                    "field-input--error": errors.manufacturer,
                  })}
                  id="manufacturer"
              ...
              <div className="field-wrapper">
                ...
                <input
                  className={classNames("field-input", {
                    "field-input--error": errors.brand,
                  })}
                  id="brand"
          ...
          <div className="flex flex-col gap-3 md:gap-4">
            ...
            <div className="card-container card-container--light rounded-2xl flex flex-col gap-3 md:gap-5">
              <DropFiles wrapperClass="card-container dark:border-border flex justify-center items-center h-[260px] border rounded-[14px] m-4 mb-0">
              ...
              <div
                className={`draggable-container flex gap-4 p-4 pt-0 ${
                  galleryIsDragging ? "dragging" : ""
                }`}
                ref={galleryContainerRef}
              >
                {Array.from({ length: 10 }).map((_, index) => (
                  <div
                    className="h-20 w-20 border shrink-0 rounded-[10px]"
